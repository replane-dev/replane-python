...
class TestSyncClientConfigValueEdgeCases:
    ...
    def test_special_characters_in_name(self, mock_server: MockSSEServer):
        ...
        with SyncReplaneClient(
            ...
            assert client.get("config-with-dashes") == 1
            assert client.get("config_with_underscores") == 2
            assert client.get("config.with.dots") == 3
            assert client.get("config:with:colons") == 4
    ...
    def test_float_value(self, mock_server: MockSSEServer):
        ...
        with SyncReplaneClient(
            ...
            assert abs(client.get("ratio") - 3.14159) < 0.0001
    ...
    def test_large_string_value(self, mock_server: MockSSEServer):
        ...
        with SyncReplaneClient(
            ...
            assert len(client.get("large")) == 10000
...
class TestSyncClientOverrideEdgeCases:
    ...
    def test_override_with_not_in_operator(self, mock_server: MockSSEServer):
        ...
        mock_server.send_init([
            create_config(
                ...
                False,
                overrides=[
                    create_override("non-blocked", True, [
                        {"operator": "not_in", "property": "country", "value": ["XX", "YY"]},
                    ]),
                ],
            ),
        ])
        ...
        with SyncReplaneClient(
            ...
            assert client.get("restricted", context={"country": "XX"}) is False
            assert client.get("restricted", context={"country": "US"}) is True
    ...
    def test_override_with_numeric_comparison(self, mock_server: MockSSEServer):
        ...
        mock_server.send_init([
            create_config(
                ...
                overrides=[
                    ...
                    create_override("medium-spenders", 10, [
                        {"operator": "greater_than_or_equal", "property": "total_spent", "value": 500},
                    ]),
                ],
            ),
        ])
        ...
        with SyncReplaneClient(
            ...
            assert client.get("discount", context={"total_spent": 500}) == 10
    ...
    def test_override_with_multiple_conditions_and(self, mock_server: MockSSEServer):
        ...
        with SyncReplaneClient(
            ...
            assert client.get("special-feature", context={"beta": True}) is False
    ...
    def test_override_missing_context_property(self, mock_server: MockSSEServer):
        ...
        mock_server.send_init([
            create_config(
                ...
                "default",
                overrides=[
                    create_override("has-user", "user-value", [
        ...
        with SyncReplaneClient(
            ...
            assert client.get("feature", context={}) == "default"
            assert client.get("feature", context={"user_id": "123"}) == "user-value"
