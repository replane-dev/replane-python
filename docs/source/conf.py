...
from replane import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "replane"
copyright = f"{datetime.today().year}, Dmitry Tilyupo"
...
html_title = f"Replane Python SDK v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/replane-dev/replane-python",
            "html": """
